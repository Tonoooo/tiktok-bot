...
# Konfigurasi API key.
# SANGAT DISARANKAN untuk menyimpan API key di variabel lingkungan (misal: GOOGLE_API_KEY)
# di server Anda, BUKAN LANGSUNG DI DALAM KODE.
# Jika Anda tetap ingin ada fallback di kode, gunakan:
# API_KEY = os.getenv("GOOGLE_API_KEY", "AIzaSyDtIN6C60dm3-c3D3t2o0sYY293xktxe_U")
# Namun, lebih baik paksa lewat environment variable saja jika untuk server.
# Untuk sementara saya kembalikan seperti sebelumnya, tapi mohon pertimbangkan environment variable.
API_KEY = os.getenv("GOOGLE_API_KEY", "AIzaSyDtIN6C60dm3-c3D3t2o0sYY293xktxe_U") 
